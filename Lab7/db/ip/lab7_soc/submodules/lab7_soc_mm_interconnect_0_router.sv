...
(
    ...
    // ( 0x8002140 .. 0x8002150 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 28'h8002140   ) begin
    ...
    // ( 0x8002160 .. 0x8002170 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 28'h8002160  && read_transaction  ) begin
    ...
    // ( 0x8002180 .. 0x8002190 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 28'h8002180   ) begin
    ...
    // ( 0x80021a0 .. 0x80021b0 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 28'h80021a0  && read_transaction  ) begin
